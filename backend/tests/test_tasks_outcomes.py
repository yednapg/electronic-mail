...
class DashboardManualTaskTests(unittest.TestCase):
    ...
    def test_dashboard_suppresses_fx_transfer_items_after_processed_notice(
        ...
        follow_up = sample_group(
            ...
            summary="Northstar assigned reference number 106400420 and said they will respond by June 10, 2026.",
        ...
        support_case = sample_group(
            ...
            summary="Northstar Bank has registered your outward remittance support query as case 106400420 and says their team is working on it.",
