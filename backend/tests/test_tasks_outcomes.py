...
class DashboardManualTaskTests(unittest.TestCase):
    ...
    def test_dashboard_suppresses_fx_transfer_items_after_processed_notice(
        ...
        deal = sample_group(
            id="deal",
            title="Northstar FX Retail Deal Confirmation",
            summary="Northstar confirms receipt of an FX booking for USD 100. The user must place a remittance request in NetBanking.",
        ...
        acknowledgement = sample_group(
            id="ack",
            title="Northstar Bank acknowledged your wire transfer inquiry",
            summary="Northstar auto-acknowledged receipt of your email about the international wire transfer status.",
        ...
        processed = sample_group(
            ...
            summary="Northstar Bank confirms an outward remittance was processed and includes the SWIFT payment message.",
        ...
        follow_up = sample_group(
            id="follow-up",
            title="Northstar Bank update on your international wire inquiry",
            summary="Northstar assigned reference number 900000002 and said they will respond by June 10, 2026.",
        ...
        support_case = sample_group(
            id="support-case",
            title="Northstar Bank remittance support case",
            summary="Northstar Bank has registered your outward remittance support query as case 900000002 and says their team is working on it.",
        ...
        messages = {
            deal.id: [
                sample_message(
                    ...
                    subject="FX Retail Deal Confirmation - CCIL Reference Number 202606020000001",
                    sender="cputrade.swiftmanagement@northstarbank.example",
                    snippet="FX Retail Trade No:202606020000001",
                    internal_date=deal.latest_message_at or "",
                    signals={"sender_domain": "bank.example.com", "ticket_id": "900000002"},
                )
            ],
            acknowledgement.id: [
                sample_message(
            ...
            processed.id: [
                sample_message(
                    ...
                    subject="Transaction advices for your company DEMO USER",
            ...
            follow_up.id: [
                sample_message(
                    ...
                    snippet="Reference number 900000002. We will respond by June 10, 2026.",
            ...
            support_case.id: [
                sample_message(
                    ...
                    subject="[Registered] - Service Request 900000002",
                    sender="care@northstarbank.example",
                    snippet="Your query/concern outward remittance support has been registered under Case Reference No.900000002.",
        ...
        self.assertNotIn("Northstar FX Retail Deal Confirmation", visible_titles)
        self.assertNotIn("Northstar Bank acknowledged your wire transfer inquiry", visible_titles)
        self.assertNotIn("Northstar Bank update on your international wire inquiry", visible_titles)
        self.assertNotIn("Northstar Bank remittance support case", visible_titles)
    ...
    def test_dashboard_ignores_trash_only_mail_groups(
        ...
        trash_message = replace(
            sample_message(
                ...
                sender="Devin <devin-verify@example.com>",
