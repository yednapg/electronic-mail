...
class EmailExtractionTests(unittest.TestCase):
    ...
    def test_bank_correspondence_reference_extracts_ticket_id(self) -> None:
        parsed = parse_gmail_message(
            {
                ...
                "labelIds": ["INBOX"],
                "snippet": "The unique reference number for this correspondence is 900000003.",
                "payload": {
                    "headers": [
                        {
                            "name": "Subject",
                    ...
                    "body": {
                        "data": encoded(
                            "Dear Customer,\n"
                            "The unique reference number for this correspondence is 900000003.\n"
                        )
                    },
                },
            },
        ...
        self.assertEqual(parsed["extracted_signals"]["ticket_id"], "900000003")
    ...
    def test_fx_retail_trade_number_extracts_trade_id_from_body(self) -> None:
        parsed = parse_gmail_message(
            {
                ...
                "payload": {
                    ...
                    "body": {
                        "data": encoded(
                            "FX-Retail Trade No. 202606020000001\n"
        ...
        self.assertEqual(parsed["extracted_signals"]["trade_id"], "202606020000001")
