...
class EmailExtractionTests(unittest.TestCase):
        ...
        parsed = parse_gmail_message(
            {
                ...
                "payload": {
                    "headers": [
                        {
                            "name": "Subject",
                            "value": "FX-Retail - Trade Confirmation of Gaurav Pandey | INPP29022231",
                        },
                        {
                            "name": "From",
    ...
    def test_thread_message_reader_splits_outlook_thread_chrome(self) -> None:
        ...
        <html><body>
          ...
          <div>HDFC Bank</div>
          <div>Contacts:</div>
          <div>Providing Rate for CCIL deal - Heena Parekh on 022 30752565</div>
          <div>From: Gaurav Pandey &lt;gaurav@example.com&gt; Sent: Tuesday, May 12, 2026 10:18 AM To: HDFCFXclearretail &lt;hdfcfxclearretail@hdfc.bank.in&gt; Subject: Re: Regarding trading limit request</div>
          ...
          <div>Official email domains: @hdfc.bank.in | @hdfcbank.bank.in</div>
