...
class SmartInboxContractTests(unittest.TestCase):
    ...
    def test_canonical_thread_title_normalizes_internal_connector_casing(self) -> None:
        message = _gmail_message(
            ...
            sender='"Screener.in" <no-reply@screener.in>',
        ...
        self.assertEqual(row.sender, "Screener.in")
    ...
    def test_canonical_thread_summary_compresses_statement_boilerplate_for_ai_titled_message(self) -> None:
        message = _gmail_message(
            ...
            sender="HSBC <notification@hsbc.co.in>",
            ai_title="HSBC statement for your account",
            snippet="Dear Customer, We enclose the statement for your account in the name of MR GAURAV PANDEY.",
            text_body="Dear Customer, We enclose the statement for your account in the name of MR GAURAV PANDEY. The statement comes to you in an easy to view PDF format. Password protection This statement is secured by a unique password.",
            extracted_signals={"sender_domain": "notification.hsbc.co.in"},
            headers={},
        )
    ...
    def test_canonical_thread_summary_compresses_support_auto_ack_boilerplate(self) -> None:
        message = _gmail_message(
            ...
            sender="Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
            ai_title="HDFC Bank: auto-acknowledgment for grievance 105715521",
            ...
            extracted_signals={"sender_domain": "hdfc.bank.in"},
            headers={},
        )

        row = _gmail_row_from_canonical_thread("complaint-auto-thread", [message], "inbox", None)

        self.assertEqual(row.title, "HDFC Bank: auto-acknowledgment for grievance 105715521 awaiting response")
        self.assertEqual(row.summary, "HDFC Bank acknowledged your grievance and says someone will respond within 3 working days.")
        self.assertNotIn("Dear Customer", row.summary or "")
    ...
    def test_reference_mailbox_display_cluster_becomes_active_conversation_work_item(self) -> None:
        row = _gmail_row_from_mailbox_display_cluster(
            "support_case:ref:hdfc:ticket_id:106756996",
            [
                _gmail_message(
                    message_id="case-opened",
                    gmail_thread_id="thread-opened",
                    subject="HDFC service request 106756996 registered",
                    snippet="Service request number 106756996 has been registered.",
                    extracted_signals={
                        "sender_domain": "hdfc.bank.in",
                        "ticket_id": "106756996",
                ...
                _gmail_message(
                    ...
                    subject="HDFC response on service request 106756996",
                    snippet="HDFC replied on your service request 106756996.",
                    extracted_signals={
                        "sender_domain": "hdfc.bank.in",
                        "ticket_id": "106756996",
        ...
        self.assertEqual(row.sender, "HDFC Bank")
        self.assertEqual(row.title, "HDFC Bank service request 106756996 registered")
        ...
        row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    sender="Upwork <alerts@upwork.com>",
                    subject="Job Alert: SwiftUI project",
                    snippet="These jobs match your alert settings.",
                    extracted_signals={"sender_domain": "upwork.com", "normalized_subject": "job alert swiftui project"},
                    headers={},
                ),
                _gmail_message(
                    message_id="job-2",
                    ...
                    snippet="These jobs match your alert settings.",
                    extracted_signals={"sender_domain": "upwork.com", "normalized_subject": "job alert macos project"},
                    headers={},
                ),
            ],
            mailbox_label="inbox",
    ...
    def test_newsletter_mailbox_display_cluster_uses_repeated_subject_provider_title(self) -> None:
        row = _gmail_row_from_mailbox_display_cluster(
            "newsletter:provider-stream:rbiretaildirect",
            [
                _gmail_message(
                    message_id="rbi-auction",
                    gmail_thread_id="thread-rbi-auction",
                    sender="Support <support@rbiretaildirect.org.in>",
                    subject="RBI Retail Direct - Auction Announcement Notification",
                    snippet="Auction announcement notification.",
                    extracted_signals={"sender_domain": "rbiretaildirect.org.in", "normalized_subject": "auction announcement notification"},
                    headers={},
                ),
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "rbiretaildirect.org.in", "normalized_subject": "access to nds om is granted"},
                    headers={},
                ),
            ],
            mailbox_label="inbox",
        ...
        row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "rbiretaildirect.org.in", "normalized_subject": "rbi auction opportunities announced"},
                    headers={},
                ...
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "rbiretaildirect.org.in", "normalized_subject": "auction notice for rbi retail direct"},
                    headers={},
                ...
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "rbiretaildirect.org.in", "normalized_subject": "nds om access approved"},
                    headers={},
        ...
        row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "upwork.com", "normalized_subject": "new job alert ai automation engineer"},
                    headers={},
                    internal_date="2026-06-12T12:00:00+00:00",
                ),
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "upwork.com", "normalized_subject": "alert ai consultant job posting"},
                    headers={},
                    internal_date="2026-06-12T11:00:00+00:00",
                ),
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "upwork.com", "normalized_subject": "new job alert ai engineering transformation consultant"},
                    headers={},
                    internal_date="2026-06-12T10:00:00+00:00",
                ),
            ],
    ...
    def test_newsletter_mailbox_display_cluster_prefers_repeated_ai_organization_title_over_acronym_domain(self) -> None:
        row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    sender="Penn State Undergraduate Admissions <admissions@psu.edu>",
                    subject="Confirming Your Application Information",
                    snippet="Review your Penn State application information.",
                    ai_title="Penn State confirms your application details",
                    extracted_signals={"sender_domain": "psu.edu", "normalized_subject": "confirming your application information"},
                    headers={},
                ),
                _gmail_message(
                    message_id="psu-pin",
                    gmail_thread_id="thread-psu-pin",
                    sender="ISSA-Adviser@psu.edu",
                    subject="Limited Services PIN",
                    snippet="Your limited services PIN is available.",
                    ai_title="Penn State limited services PIN",
                    extracted_signals={"sender_domain": "psu.edu", "normalized_subject": "limited services pin"},
                    headers={},
                ),
            ],
            mailbox_label="inbox",
        ...
        self.assertEqual(row.sender, "Penn State")
        ...
        row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    sender="HSBC India <mail@hsbc.co.in>",
                    subject="HSBC SimplyPay reward promotion",
                    snippet="Reward promotion.",
                    extracted_signals={"sender_domain": "hsbc.co.in", "normalized_subject": "hsbc simplypay reward promotion"},
                    headers={},
                ),
                _gmail_message(
                    ...
                    extracted_signals={"sender_domain": "hsbc.co.in", "normalized_subject": "hsbc invitation to an emerging markets webinar"},
                    headers={},
                ),
            ],
            mailbox_label="inbox",
        ...
        row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    sender="Head Retail Banking INM <headretailbanking@hsbc.co.in>",
                    ...
                    extracted_signals={"sender_domain": "hsbc.co.in", "ticket_id": "2260262693"},
                    headers={},
                ),
                _gmail_message(
                    message_id="hsbc-followup",
                    gmail_thread_id="thread-hsbc-followup",
                    sender="Sm Response INM <smresponseinm@hsbc.co.in>",
    ...
    def test_fx_retail_trade_id_cluster_groups_hdfc_and_ccil_messages(self) -> None:
        messages = [
            _gmail_message(
                message_id="hdfc-trade-confirmation",
                gmail_thread_id="thread-hdfc-trade-confirmation",
                sender="HDFCFXclearretail <hdfcfxclearretail@hdfc.bank.in>",
                subject="FX Retail Deal Confirmation - CCIL Reference Number 202606029000072",
                snippet="FX Retail Trade No:202606029000072.",
                ai_title="HDFC confirms FX retail trade 202606029000072",
                extracted_signals={
                    "sender_domain": "hdfc.bank.in",
            ...
            _gmail_message(
                ...
                subject="FX-Retail - Trade Confirmation of Gaurav Pandey | INPP29022231",
                snippet="FX-Retail Trade No. 202606029000072. Relationship Bank HDFC BANK LIMITED.",
                ai_title="FX-Retail trade confirmation for 202606029000072",
                extracted_signals={
                    "sender_domain": "ccilindia.co.in",
                    "trade_id": "202606029000072",
                    "normalized_subject": "fx-retail trade confirmation of gaurav pandey inpp29022231",
                },
                headers={},
            ),
        ]
        ...
        self.assertEqual({child.message_id for child in row.children}, {"hdfc-trade-confirmation", "ccil-trade-confirmation"})
    ...
    def test_mailbox_rows_absorb_trade_reference_after_ai_group_rendering(self) -> None:
        hdfc_group = GmailThreadRow(
            thread_id="hdfc-ai-group",
            entity_id="hdfc-ai-group",
            title="FX retail trade validation issue",
            href="/v1/mailbox/threads/hdfc-ai-group",
            latest_source_record_id="hdfc-trade-confirmation",
            ...
            latest_sender="HDFCFXclearretail <hdfcfxclearretail@hdfc.bank.in>",
            sender="HDFC Bank",
            participants=["HDFC Bank"],
            message_count=3,
            summary="HDFC Bank confirmed FX retail trade 202606029000072, and the related support thread shows validation trouble.",
            ai_group_id="hdfc-ai-group",
            ai_title="FX retail trade validation issue",
            ai_summary="HDFC Bank confirmed FX retail trade 202606029000072, and the related support thread shows validation trouble.",
            snippet="FX Retail Trade No:202606029000072.",
            label_ids=["INBOX"],
            labels=["INBOX"],
            action_needed=False,
            ...
            children=[
                ...
                {
                    "message_id": "hdfc-support-reply",
                    "gmail_thread_id": "thread-validation",
                    "sender": "HDFC Bank <care@hdfc.bank.in>",
        ...
        ccil_row = GmailThreadRow(
            ...
            latest_subject="FX-Retail - Trade Confirmation of Gaurav Pandey | INPP29022231",
        ...
        rows = _mailbox_rows_absorbing_trade_references([hdfc_group, ccil_row], mailbox_label="inbox")
        ...
        self.assertEqual({child.message_id for child in rows[0].children}, {"hdfc-trade-confirmation", "hdfc-support-reply", "ccil-trade-confirmation"})
    ...
    def test_mailbox_rows_absorb_ticket_reference_after_ai_group_rendering(self) -> None:
        hdfc_group = GmailThreadRow(
            thread_id="hdfc-ai-group-105715521",
            entity_id="hdfc-ai-group-105715521",
            title="HDFC Bank grievance case 105715521",
            href="/v1/mailbox/threads/hdfc-ai-group-105715521",
            latest_source_record_id="hdfc-ticket-reply",
            latest_received_at="2026-06-05T10:00:00+05:30",
            latest_message_at="2026-06-05T10:00:00+05:30",
            latest_subject="HDFC update on service request 105715521",
            latest_sender="Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
            sender="HDFC Bank",
            participants=["HDFC Bank"],
            message_count=2,
            summary="HDFC Bank replied on grievance case 105715521.",
            ai_group_id="hdfc-ai-group-105715521",
            ai_title="HDFC Bank grievance case 105715521",
            ai_summary="HDFC Bank replied on grievance case 105715521.",
            snippet="HDFC replied on case 105715521.",
            label_ids=["INBOX"],
            labels=["INBOX"],
            action_needed=False,
            action_type="review",
            ...
            children=[
                {
                    "message_id": "hdfc-ticket-ack",
                    "gmail_thread_id": "thread-ticket-ack",
                    "sender": "Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
                    "subject": "HDFC acknowledgement of service request 105715521",
                    "snippet": "HDFC acknowledged service request 105715521.",
                    "received_at": "2026-05-30T09:00:00+05:30",
                },
                {
                    "message_id": "hdfc-ticket-reply",
                    "gmail_thread_id": "thread-ticket-reply",
                    "sender": "Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
                    "subject": "HDFC update on service request 105715521",
                    "snippet": "HDFC replied on service request 105715521.",
        ...
        hdfc_followup = GmailThreadRow(
            thread_id="thread-hdfc-privacy-105715521",
            entity_id="thread-hdfc-privacy-105715521",
            title="HDFC credit card consent/privacy case 105715521",
            href="/v1/mailbox/threads/thread-hdfc-privacy-105715521",
            latest_source_record_id="hdfc-privacy-followup",
            latest_received_at="2026-05-29T11:00:00+05:30",
            latest_message_at="2026-05-29T11:00:00+05:30",
            latest_subject="HDFC credit card consent/privacy case 105715521",
            latest_sender="HDFC Bank <alerts@hdfc.bank.in>",
            sender="HDFC Bank",
            participants=["HDFC Bank"],
            message_count=1,
            summary="HDFC referenced service request 105715521 in the consent/privacy complaint.",
            ai_group_id=None,
            ai_title="HDFC credit card consent/privacy case 105715521",
            ai_summary="HDFC referenced service request 105715521 in the consent/privacy complaint.",
            ...
            children=[
                {
                    "message_id": "hdfc-privacy-followup",
                    "gmail_thread_id": "thread-hdfc-privacy-105715521",
                    "sender": "HDFC Bank <alerts@hdfc.bank.in>",
                    "subject": "HDFC credit card consent/privacy case 105715521",
                    "snippet": "Service request 105715521 is under review.",
        ...
        rows = _mailbox_rows_absorbing_exact_references([hdfc_group, hdfc_followup], mailbox_label="inbox")

        self.assertEqual(len(rows), 1)
        self.assertEqual(rows[0].sender, "HDFC Bank")
        self.assertEqual(rows[0].title, "HDFC Bank grievance case 105715521")
        self.assertEqual(rows[0].ai_title, "HDFC Bank grievance case 105715521")
        self.assertEqual(rows[0].message_count, 3)
        self.assertEqual({child.message_id for child in rows[0].children}, {"hdfc-ticket-ack", "hdfc-ticket-reply", "hdfc-privacy-followup"})
        ...
        self.assertEqual(rows[0].grouping_metadata["reference"]["provider"], "hdfc")

    def test_mailbox_ticket_reference_title_prefers_outcome_over_registration(self) -> None:
        conversation = _validated_thread_row(
            _thread_row(
                thread_id="hdfc-remittance-conversation",
                message_count=3,
                ai_group_id="ai-hdfc-remittance",
                presentation_status="ai_ready",
                children=[("wire-opened", "thread-wire"), ("wire-registered", "thread-wire"), ("wire-processed", "thread-wire")],
            ).model_copy(
                update={
                    "sender": "HDFC Bank",
                    "latest_sender": "HDFC Bank <care@hdfc.bank.in>",
                    "title": "HDFC Bank registers wire status case 106400420",
                    "ai_title": "HDFC Bank registers wire status case 106400420",
                    "summary": "HDFC Bank registered and then processed the remittance support case.",
                    "ai_summary": "HDFC Bank registered and then processed the remittance support case.",
                    ...
                    "children": [
                        {
                            ...
                            "ai_title": "HDFC Bank auto-acknowledgment for wire status request",
                        ...
                        },
                        {
                            ...
                            "gmail_thread_id": "thread-wire",
                            "sender": "HDFC Bank Care",
                            "subject": "[Registered] - Service Request 106400420",
                            "ai_title": "HDFC: service request 106400420 registered",
                        ...
                        },
                        {
                            ...
                            "ai_title": "HDFC Bank confirms outward remittance processed",
                            "snippet": "HDFC confirmed the outward remittance was processed.",
        ...
        registration = _validated_thread_row(
            _thread_row(
                thread_id="hdfc-remittance-registration",
                message_count=1,
                ai_group_id=None,
                presentation_status="ai_ready",
                ...
                update={
                    "sender": "HDFC Bank Care",
                    "latest_sender": "HDFC Bank Care <care@hdfc.bank.in>",
                    "title": "HDFC Bank registers remittance case 106400420",
                    "ai_title": "HDFC Bank registers remittance case 106400420",
                    "summary": "HDFC Bank registered service request 106400420.",
                    "ai_summary": "HDFC Bank registered service request 106400420.",
        ...
        self.assertEqual(len(rows), 1)
        self.assertEqual(rows[0].title, "HDFC: remittance processed for case 106400420")
    ...
    def test_mailbox_ticket_reference_absorption_requires_same_provider(self) -> None:
        hdfc_row = GmailThreadRow(
            thread_id="thread-hdfc-case",
            entity_id="thread-hdfc-case",
            title="HDFC service request 123456789",
            href="/v1/mailbox/threads/thread-hdfc-case",
            latest_source_record_id="hdfc-case",
            latest_received_at="2026-06-05T10:00:00+05:30",
            latest_message_at="2026-06-05T10:00:00+05:30",
            latest_subject="HDFC service request 123456789",
            latest_sender="HDFC Bank <alerts@hdfc.bank.in>",
            sender="HDFC Bank",
            participants=["HDFC Bank"],
            message_count=1,
            summary="HDFC replied on service request 123456789.",
            ai_title="HDFC service request 123456789",
            ai_summary="HDFC replied on service request 123456789.",
        ...
        rows = _mailbox_rows_absorbing_exact_references([hdfc_row, hsbc_row], mailbox_label="inbox")

        self.assertEqual([row.thread_id for row in rows], ["thread-hdfc-case", "thread-hsbc-case"])
    ...
    def test_mailbox_exact_reference_absorption_groups_repair_lifecycle(self) -> None:
        work_authorization = GmailThreadRow(
            ...
            latest_sender="Apple Saket <donotreply@email.apple.com>",
            sender="Apple",
        ...
        service_confirmation = work_authorization.model_copy(
            update={
                ...
                "latest_sender": "Apple Saket <donotreply@email.apple.com>",
                "sender": "Apple Saket <donotreply@email.apple.com>",
                "participants": ["Apple Saket"],
        ...
        github_row = _gmail_row_from_mailbox_display_cluster(
            ...
            [
                _gmail_message(
                    ...
                    sender="GitHub Education <edu-noreply@github.com>",
    ...
    def test_provider_stream_does_not_merge_github_operational_updates(self) -> None:
        messages = [
            _gmail_message(
                ...
                gmail_thread_id="thread-github-education",
                sender="GitHub Education <edu-noreply@github.com>",
                subject="[GitHub Education] @yednapg",
            ...
            _gmail_message(
                ...
                sender="gaurav-archive <notifications@github.com>",
    ...
    def test_generic_inbox_sender_falls_back_to_domain_owner_title(self) -> None:
        hdfc_bank_message = _gmail_message(
            sender="Support <support@hdfc.bank.in>",
            subject="HDFC Bank international wire N26153141140349",
            snippet="Your HDFC Bank international wire has been processed.",
            extracted_signals={"sender_domain": "hdfc.bank.in", "normalized_subject": "international wire n26153141140349"},
            headers={},
        )
        compressed_hdfc_message = _gmail_message(
            message_id="hdfc-compressed",
            gmail_thread_id="thread-hdfc-compressed",
            sender="TradeQualityUnit@hdfcbank.bank.in",
            subject="Outward remittance processed",
            snippet="HDFC Bank says an outward remittance was processed.",
            extracted_signals={"sender_domain": "hdfcbank.bank.in", "normalized_subject": "outward remittance processed"},
            headers={},
        )
        compressed_rbi_message = _gmail_message(
            message_id="rbi-compressed",
            gmail_thread_id="thread-rbi-compressed",
            sender="support@rbiretaildirect.org.in",
            subject="RBI Retail Direct account approved",
            snippet="RBI Retail Direct account opening request was processed.",
            extracted_signals={"sender_domain": "rbiretaildirect.org.in", "normalized_subject": "rbi retail direct account approved"},
            headers={},
        )
        default_user_message = _gmail_message(
            message_id="hdfc-default-user",
            gmail_thread_id="thread-hdfc-default-user",
            sender="Default User <care@hdfcbank.bank.in>",
            subject="HDFC Bank service request resolved",
            snippet="HDFC Bank marked the service request resolved.",
            extracted_signals={"sender_domain": "hdfcbank.bank.in", "normalized_subject": "service request resolved"},
            headers={},
        )
        compressed_display_message = _gmail_message(
            message_id="hdfc-fx-compressed",
            gmail_thread_id="thread-hdfc-fx-compressed",
            sender="HDFCFXclearretail <hdfcfxclearretail@hdfc.bank.in>",
            subject="FX retail trade validation issue",
            snippet="HDFC Bank confirmed the FX retail trade.",
            extracted_signals={"sender_domain": "hdfc.bank.in", "normalized_subject": "fx retail trade validation issue"},
            headers={},
        )
        ...
        service_channel_message = _gmail_message(
            message_id="hdfc-grievance",
            gmail_thread_id="thread-hdfc-grievance",
            sender="Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
            subject="HDFC Bank grievance case 105715521",
            snippet="HDFC Bank replied on the grievance case.",
            extracted_signals={"sender_domain": "hdfc.bank.in", "normalized_subject": "hdfc bank grievance case 105715521"},
            headers={},
        )
        ...
        psu_message = _gmail_message(
            ...
            sender="International@psu.edu",
            subject="Visa document next steps",
            snippet="Penn State needs visa document information.",
            ai_title="Penn State visa document next steps",
            extracted_signals={"sender_domain": "psu.edu", "normalized_subject": "visa document next steps"},
            headers={},
        )
        neo_greeting_message = _gmail_message(
            ...
            snippet="Hi Gaurav, Shivay Lamba has submitted their reference for your Neo Residency application.",
        ...
        hack_club_greeting_message = _gmail_message(
            ...
            snippet="Hi Gaurav Pandey, thank you for your generous donation to Hackaccino.",
        ...
        ibkr_fyi_message = _gmail_message(
            ...
            sender="IBKR FYI <donotreply@interactivebrokers.com>",
            ...
            extracted_signals={"sender_domain": "interactivebrokers.com", "normalized_subject": "deposit activity update"},
            headers={},
        )

        hdfc_bank_row = _gmail_row_from_canonical_thread("hdfc-wire", [hdfc_bank_message], "inbox", None)
        compressed_hdfc_row = _gmail_row_from_canonical_thread("hdfc-compressed", [compressed_hdfc_message], "inbox", None)
        compressed_rbi_row = _gmail_row_from_canonical_thread("rbi-compressed", [compressed_rbi_message], "inbox", None)
        default_user_row = _gmail_row_from_canonical_thread("hdfc-default-user", [default_user_message], "inbox", None)
        compressed_display_row = _gmail_row_from_canonical_thread("hdfc-fx-compressed", [compressed_display_message], "inbox", None)
        compressed_india_domain_row = _gmail_row_from_canonical_thread("ccil-compressed", [compressed_india_domain_message], "inbox", None)
        service_channel_row = _gmail_row_from_canonical_thread("hdfc-grievance", [service_channel_message], "inbox", None)
        ...
        self.assertEqual(hdfc_bank_row.sender, "HDFC Bank")
        self.assertEqual(compressed_hdfc_row.sender, "HDFC Bank")
        self.assertEqual(compressed_rbi_row.sender, "RBI Retail Direct")
        self.assertEqual(default_user_row.sender, "HDFC Bank")
        self.assertEqual(compressed_display_row.sender, "HDFC Bank")
        self.assertEqual(compressed_india_domain_row.sender, "CCIL India")
        self.assertEqual(service_channel_row.sender, "HDFC Bank")
        ...
        self.assertEqual(psu_row.sender, "Penn State")
    ...
    def test_inbox_thread_sender_prefers_latest_inbound_when_latest_message_is_sent(self) -> None:
        inbound = _gmail_message(
            message_id="hdfc-inbound",
            gmail_thread_id="thread-hdfc-card",
            sender="Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
            subject="Re: Credit Limit Increase & Card Upgrade Request",
            snippet="HDFC Bank asks for income tax return documents.",
            ai_title="Bank requests income tax return documents",
            label_ids=["INBOX"],
            internal_date="2026-04-23T23:58:10+05:30",
            extracted_signals={"sender_domain": "hdfc.bank.in", "normalized_subject": "credit limit card upgrade request"},
            headers={},
        )
        sent_reply = _gmail_message(
            message_id="hdfc-sent-reply",
            gmail_thread_id="thread-hdfc-card",
            sender="Gaurav Pandey <gaurav@pandey.family>",
            subject="Re: Credit Limit Increase & Card Upgrade Request",
        ...
        row = _gmail_row_from_canonical_thread("thread-hdfc-card", [inbound, sent_reply], "inbox", None)

        self.assertEqual(row.sender, "HDFC Bank")
        self.assertEqual(row.latest_sender, "Gaurav Pandey <gaurav@pandey.family>")
        self.assertEqual(row.children[-1].sender, "Gaurav Pandey")

    def test_inbox_sent_only_row_uses_recipient_as_sender(self) -> None:
        sent_message = _gmail_message(
            message_id="hdfc-sent-only",
            gmail_thread_id="thread-hdfc-sent-only",
            sender="Gaurav Pandey <gaurav@pandey.family>",
            ...
            headers={"to": "priorityredressal.creditcards@hdfc.bank.in"},
            recipients={"to": "priorityredressal.creditcards@hdfc.bank.in"},
        )

        row = _gmail_row_from_canonical_thread("thread-hdfc-sent-only", [sent_message], "inbox", None)

        self.assertEqual(row.sender, "HDFC Bank")
        self.assertEqual(row.latest_sender, "Gaurav Pandey <gaurav@pandey.family>")
        self.assertEqual(row.children[0].sender, "Gaurav Pandey")
    ...
    def test_mail_object_bundle_prefers_specific_sender_over_default_user(self, mock_bundles: Mock) -> None:
        ...
        mock_bundles.return_value = [
            MailObjectBundle(
                object=MailObjectRecord(
                    ...
                    user_id="user-1",
                    object_type="ticket",
                    canonical_key="ticket_id:hdfcbank:105991218",
                    title="HDFC Bank service request resolved",
                    summary="HDFC Bank registered and resolved service request 105991218.",
                    lifecycle_state="active",
                    confidence=1.0,
                    evidence={"signal_name": "ticket_id"},
                    created_at="2026-06-11T10:00:00+00:00",
                ...
                messages=[
                    _gmail_message(
                        ...
                        sender="Default User <care@hdfcbank.bank.in>",
                        extracted_signals={"sender_domain": "hdfcbank.bank.in", "ticket_id": "105991218"},
                        headers={},
                    ),
                    _gmail_message(
                        message_id="registered",
                        gmail_thread_id="thread-registered",
                        sender="HDFC Bank Care <care@hdfcbank.bank.in>",
                        extracted_signals={"sender_domain": "hdfcbank.bank.in", "ticket_id": "105991218"},
                        headers={},
                    ),
                ],
        ...
        self.assertEqual(len(rows), 1)
        self.assertEqual(rows[0].primary_sender, "HDFC Bank Care")
    ...
    def test_trade_mail_object_absorbs_overlapping_validation_group_with_fx_sender(self, mock_bundles: Mock) -> None:
            ...
            sections=[
                {
                    ...
                    "rows": [
                        GmailThreadRow(
                            ...
                            participants=["HDFC Bank"],
                            message_count=3,
                            summary="HDFC support said the FX retail trade could not be validated in netbanking.",
                            ai_group_id="group-validation",
                            ai_title="FX retail trade validation issue",
                            ai_summary="HDFC support said the FX retail trade could not be validated in netbanking.",
            ...
            MailObjectBundle(
                ...
                messages=[
                    _gmail_message(
                        ...
                        sender="HDFCFXclearretail <hdfcfxclearretail@hdfc.bank.in>",
                        subject="FX Retail Deal Confirmation - CCIL Reference Number 202606029000072",
                        extracted_signals={"sender_domain": "hdfc.bank.in", "trade_id": "202606029000072"},
                        headers={},
                    ),
                    _gmail_message(
                        message_id="ccil-trade-confirmation",
        ...
        self.assertEqual(set(rows[0].source_message_ids), {"hdfc-trade-confirmation", "ccil-trade-confirmation", "hdfc-support-reply"})
        ...
        mock_bundles.return_value = [
            MailObjectBundle(
                object=MailObjectRecord(
                    ...
                    user_id="user-1",
                    object_type="ticket",
                    canonical_key="ticket_id:hdfc:105715521",
                    title="HDFC Bank grievance case 105715521",
                    summary="HDFC Bank replied on the grievance case.",
                    lifecycle_state="active",
                    confidence=1.0,
                    evidence={"signal_name": "ticket_id"},
                    created_at="2026-06-11T10:00:00+00:00",
                ...
                messages=[
                    _gmail_message(
                        ...
                        sender="Grievance-Redressalcc <grievance.redressalcc@hdfc.bank.in>",
                        extracted_signals={"sender_domain": "hdfc.bank.in", "ticket_id": "105715521"},
                        headers={},
                    ),
                    _gmail_message(
    ...
    def test_mail_object_absorbs_overlapping_ai_group_without_duplicate_row(self, mock_bundles: Mock) -> None:
        ai_group = _thread_row(
            ...
            update={
                "title": "HDFC credit card consent complaint 105715521",
                "summary": "HDFC acknowledged the privacy complaint under case 105715521 and later followed up.",
                "ai_title": "HDFC credit card consent complaint 105715521",
                "ai_summary": "HDFC acknowledged the privacy complaint under case 105715521 and later followed up.",
        ...
        mock_bundles.return_value = [
            MailObjectBundle(
                ...
                messages=[
                    _gmail_message(message_id="ticket-reply", gmail_thread_id="thread-ticket-105715521", extracted_signals={"sender_domain": "hdfc.bank.in", "ticket_id": "105715521"}, headers={}),
                    _gmail_message(message_id="ticket-followup", gmail_thread_id="thread-ticket-105715521", extracted_signals={"sender_domain": "hdfc.bank.in", "ticket_id": "105715521"}, headers={}),
                ],
            )
        ]
        ...
        self.assertEqual(len(rows), 1)
        self.assertEqual(rows[0].row_key, "mail-object:ticket_id:hdfc:105715521")
        self.assertEqual(rows[0].title, "HDFC credit card consent complaint 105715521")
        self.assertEqual(
        ...
        self.assertEqual(rows[0].grouping_reason["absorbed_mailbox_rows"][0]["row_key"], "ai-hdfc-complaint-group")

    def test_smart_inbox_absorbs_registration_row_when_ai_titles_share_service_request_reference(self) -> None:
        conversation = _validated_thread_row(
            _thread_row(
                thread_id="ai-hdfc-remittance-conversation",
                message_count=3,
                ...
                update={
                    ...
                    "summary": "HDFC replied about the outward remittance and next steps.",
                    "ai_title": "Wire transfer status with HDFC Bank",
                    "ai_summary": "HDFC replied about the outward remittance and next steps.",
                    ...
                    "sender": "HDFC Bank",
                    "latest_sender": "HDFC Bank <care@hdfcbank.bank.in>",
                    "children": [
                        {
                            "message_id": "wire-opened",
                            ...
                            "sender": "HDFC Bank",
                            "subject": "Outward remittance processed",
                            "ai_title": "HDFC acknowledges remittance inquiry: case 106400420",
                            "snippet": "HDFC acknowledged the remittance inquiry.",
                        ...
                        },
                        {
                            ...
                            "ai_title": "HDFC Bank: wire processed for case 106400420",
                            "snippet": "HDFC replied with wire transfer status.",
                        ...
                        },
                        {
                            ...
                            "ai_title": "HDFC Bank replies on remittance case 106400420",
                            "snippet": "HDFC replied on the remittance case.",
        ...
        registration = _validated_thread_row(
            _thread_row(
                thread_id="ai-hdfc-service-request-106400420",
                message_count=1,
                ...
                update={
                    "title": "HDFC remittance support request",
                    "summary": "HDFC Bank registered service request 106400420.",
                    "ai_title": "HDFC Bank registers remittance case 106400420",
                    "ai_summary": "HDFC Bank registered service request 106400420.",
                    ...
                    "sender": "HDFC Bank Care <care@hdfcbank.bank.in>",
                    "latest_sender": "HDFC Bank Care <care@hdfcbank.bank.in>",
                    "children": [
                        {
        ...
        self.assertEqual(rows[0].title, "Wire transfer status with HDFC Bank")
        self.assertEqual(
            set(rows[0].source_message_ids),
    ...
    def test_smart_reference_absorption_rejects_conflicting_visible_service_request(self) -> None:
        target = _validated_thread_row(
            _thread_row(
                thread_id="ai-hdfc-service-request-106756996",
                message_count=1,
                ...
                update={
                    "title": "HDFC service request 106756996 registered",
                    "summary": "HDFC Bank registered service request 106756996.",
                    "ai_title": "HDFC Bank registers service request 106756996",
                    "sender": "HDFC Bank Care <care@hdfcbank.bank.in>",
                    "latest_sender": "HDFC Bank Care <care@hdfcbank.bank.in>",
                    "children": [
                        {
        ...
        conflicting = _validated_thread_row(
            _thread_row(
                thread_id="ai-hdfc-conflicting-visible-reference",
                message_count=2,
                ...
                update={
                    "title": "HDFC response on service request 106756996",
                    "summary": "HDFC also references older grievance case 105715521 in the same conversation.",
                    "ai_title": "HDFC response on service request 106756996",
                    "sender": "HDFC Bank",
                    "latest_sender": "HDFC Bank <care@hdfcbank.bank.in>",
                    "children": [
                        {
                            ...
                            "subject": "HDFC response on service request 106756996",
                            "ai_title": "HDFC response on service request 106756996",
                            "snippet": "HDFC replied on service request 106756996.",
                            "received_at": "2026-06-11T10:00:00+00:00",
                        },
                        {
                            ...
                            "sender": "HDFC Bank",
                            "subject": "HDFC acknowledgement of service request 105715521",
                            "ai_title": "HDFC acknowledgement of service request 105715521",
                            "snippet": "HDFC acknowledged service request 105715521.",
                            "received_at": "2026-06-11T10:00:00+00:00",
                        },
                    ],
        ...
        rows = [
            _smart_row_with_workflow_object(
                _smart_row(
                    ...
                    primary_sender="RBI Retail Direct <support@rbiretaildirect.example>",
                ),
            ...
            _smart_row_with_workflow_object(
                _smart_row(
                    ...
                    primary_sender="RBI Retail Direct Support <support@rbiretaildirect.example>",
                ),
                value="rbi-retail-direct-account-setup",
                object_type="account_setup",
            ),
    ...
    def test_smart_workflow_cluster_groups_hdfc_wire_remittance_context_without_fx_trade_rows(self) -> None:
        rows = [
            _smart_row_with_workflow_object(
                _smart_row(
                    row_id="smart-row:hdfc-wire-status",
                    row_key="thread-hdfc-wire-status",
                    title="Wire transfer status with HDFC Bank",
                    summary="You asked HDFC Bank to check the status of an outward remittance, and the bank replied through the same reference thread.",
                    primary_sender="HDFC Bank",
            ...
            _smart_row_with_workflow_object(
                _smart_row(
                    row_id="smart-row:hdfc-remittance-processed",
                    row_key="thread-hdfc-remittance-processed",
                    title="Outward remittance processed",
                    summary="HDFC Bank says an outward remittance was processed and included the SWIFT message copy for reference.",
                    primary_sender="HDFC Bank",
            ...
            _smart_row(
                row_id="smart-row:hdfc-fx-validation",
                row_key="thread-hdfc-fx-validation",
                title="FX retail trade validation issue",
                summary="HDFC Bank confirmed FX retail trade 202606029000072 and the related support thread shows trouble validating the trade number.",
                primary_sender="HDFC Bank",
        ...
        remittance = next(row for row in clustered if row.row_key.startswith("smart-workflow:hdfc-bank:wire-remittance:"))
        self.assertEqual(remittance.row_type, "related_bundle")
        self.assertEqual(remittance.primary_sender, "HDFC Bank")
        self.assertEqual(remittance.title, "HDFC Bank outward remittance processed")
        self.assertEqual(remittance.summary, "5 related emails for HDFC Bank outward remittance processed.")
        self.assertEqual(
    ...
    def test_smart_workflow_cluster_groups_penn_state_application_lifecycle_only(self) -> None:
        rows = [
            _smart_row_with_workflow_object(
                _smart_row(
                    ...
                    title="Penn State application and next steps",
                    summary="Penn State has updated the application and sent admitted-student next steps.",
                    primary_sender="Penn State",
            ...
            _smart_row_with_workflow_object(
                _smart_row(
                    ...
                    title="Penn State cost estimate available",
                    summary="Penn State says estimated educational costs are available in LionPATH.",
                    primary_sender="Penn State",
            ...
            _smart_row_with_workflow_object(
                _smart_row(
                    ...
                    title="Penn State reconsideration question answered",
                    summary="Penn State Behrend answered a reconsideration question for the current acceptance.",
                    primary_sender="Penn State Behrend <behrend.admissions@psu.edu>",
            ...
            _smart_row_with_workflow_object(
                _smart_row(
                    ...
                    title="Penn State application update",
                    summary="Penn State Undergraduate Admissions says the application was updated in MyPennState.",
                    primary_sender="Penn State",
        ...
        self.assertEqual(penn.title, "Penn State admission, costs, and reconsideration")
        self.assertEqual(penn.summary, "5 related emails for Penn State admission, costs, and reconsideration.")
        self.assertEqual(
    ...
    def test_smart_workflow_cluster_requires_shared_workflow_object(self) -> None:
        rows = [
            _smart_row(
                ...
                row_key="thread-hdfc-wire-status",
                title="Wire transfer status with HDFC Bank",
                summary="HDFC Bank replied about an outward remittance status request.",
                primary_sender="HDFC Bank",
            ...
            _smart_row(
                ...
                row_key="thread-hdfc-remittance-processed",
                title="Outward remittance processed",
                summary="HDFC Bank says an outward remittance was processed.",
                primary_sender="HDFC Bank",
                source_message_ids=["remittance-advice"],
            ),
            _smart_row(
                row_id="smart-row:hdfc-remittance-query",
                row_key="thread-hdfc-remittance-query",
                title="HDFC outward remittance query received",
                summary="HDFC Bank acknowledged a different outward remittance query.",
                primary_sender="HDFC Bank",
    ...
    def test_smart_inbox_rows_drive_work_queue_without_resolved_open_rows_as_needs_action(self) -> None:
        smart = _smart_inbox_response_from_rows(
            [
                ...
                _smart_row(
                    row_id="smart-row:hdfc-resolved",
                    row_key="thread-hdfc-resolved",
                    title="HDFC Bank service request resolved",
                    summary="HDFC marked the service request resolved.",
                    primary_sender="HDFC Bank Care <care@hdfcbank.bank.in>",
                    row_type="verified_group",
                    action_type="open",
                    priority=98,
                ),
        ...
        self.assertEqual([item.smart_row_id for item in queue.important_updates], ["smart-row:hdfc-resolved"])
    ...
    def test_replace_smart_projection_materializes_thread_titles_without_summary_cache(self) -> None:
        ...
        row = {
            ...
            "row_type": "verified_group",
            "title": "HDFC ticket 106756996",
            "summary": "Two emails are about the same HDFC ticket.",
        ...
        self.assertEqual({summary["ai_title"] for summary in summaries}, {"HDFC ticket 106756996"})
    ...
    def test_gmail_message_upsert_materializes_message_signals(self) -> None:
        ...
        message = _gmail_message(
            extracted_signals={
                ...
                "ticket_id": "106756996",
                "trade_id": "202606029000072",
                "domains": ["hdfcbank.com", "netbanking.hdfcbank.com"],
                "list_id": "alerts.hdfcbank.com",
                "in_reply_to": "<reply@example.com>",
                "references": "<root@example.com> <reply@example.com>",
            },
            headers={
                "message-id": "<msg@example.com>",
                "list-unsubscribe": "<https://hdfcbank.com/unsubscribe>",
            },
        )
        ...
        self.assertEqual(signal_params["sender_domain"], "hdfcbank.com")
        ...
        self.assertEqual(json_loads(signal_params["links_json"]), [{"domain": "hdfcbank.com"}, {"domain": "netbanking.hdfcbank.com"}])
        self.assertIn("<root@example.com>", json_loads(signal_params["reply_refs_json"]))
        self.assertEqual(
            json_loads(signal_params["list_signals_json"]),
            {"list_id": "alerts.hdfcbank.com", "list_unsubscribe": "<https://hdfcbank.com/unsubscribe>"},
        )
    ...
    def test_trade_id_messages_materialize_shared_cross_provider_mail_object(self) -> None:
        connection = FakeConnection()
        hdfc = _gmail_message(
            message_id="hdfc-trade",
            sender="HDFC FX Retail <hdfcfxclearretail@hdfc.bank.in>",
            extracted_signals={
                "sender_domain": "hdfc.bank.in",
                "normalized_subject": "fx retail deal confirmation ccil reference number 202606029000072",
                "trade_id": "202606029000072",
        ...
        with patch("app.db.mail_groups.get_engine", return_value=FakeEngine(connection)):
            count = upsert_gmail_messages("postgresql://example/db", [hdfc, ccil])
        ...
        self.assertEqual({param["object_id"] for param in member_params}, {object_params[0]["id"]})
        self.assertEqual({param["gmail_message_id"] for param in member_params}, {"hdfc-trade", "ccil-trade"})
...
def _gmail_message(
    *,
    ...
    sender: str = "HDFC Bank <alerts@hdfcbank.com>",
