...
class EntityResolutionTests(unittest.TestCase):
    ...
    def test_different_case_id_subjects_are_not_considered_similar(self) -> None:
        confidence = get_subject_confidence("case id 0009000022", "case id 0009000011")
        self.assertEqual(confidence, 0.0)
    ...
    def test_related_threads_can_be_considered_across_sender_subdomains(self) -> None:
        ...
        callback_record = build_record(
            ...
            subject="Request for Clarification on Email ID Modification Rejection [Ticket #20250805000001]- Zerodha Helpdesk",
