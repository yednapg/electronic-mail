...
class SmartInboxQualityTests(unittest.TestCase):
        ...
        report = audit_smart_inbox_quality(
            _mailbox(
                _row(
                    ...
                    title="Northstar Bank service request 106400420 updated",
    ...
    def test_smart_cross_thread_mail_object_evidence_passes(self) -> None:
        smart = _smart_inbox(
            _smart_row(
                ...
                "Northstar Bank service request 106756996 resolved",
                source_thread_ids=["thread-1", "thread-2"],
                source_message_ids=["msg-1", "msg-2"],
                grouping_reason={
                    "source": "mail_object",
                    "canonical_key": "ticket_id:northstar:106756996",
    ...
    def test_smart_inbox_blocks_stacked_state_titles(self) -> None:
        smart = _smart_inbox(
            _smart_row("smart-row:pending-resolved", "Northstar grievance 105715521 pending response resolved"),
