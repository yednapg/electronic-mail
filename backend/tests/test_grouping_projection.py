...
def message(
    ...
    *,
    ...
    return GmailMessageRecord(
        ...
        text_body=None,
        extracted_signals=signals or {"sender_domain": "northstarbank.example", "ticket_id": "106400420"},
...
def group(
    ...
    *,
    ...
    return MailGroupRecord(
        ...
        ai_summary="Northstar updated service request 106400420.",
        labels=["support_case"],
        action_needed=False,
        action_type="open",
        priority=20,
        ...
        or {
            ...
            "facts": {"provider": "northstar", "reference_id": "ticket_id:106400420"},
        },
...
class GroupingProjectionTests(unittest.TestCase):
    def test_exact_reference_cross_thread_group_passes(self) -> None:
        ...
        decision = evaluate_inbox_candidate(group("group-1", group_key="ticket_id:northstarbank.example:106400420"), messages)

        self.assertTrue(decision.accepted)
        self.assertEqual(decision.group_kind, "lifecycle")
        self.assertEqual(decision.canonical_entity, "Northstar Bank")
        self.assertIn("ticket_id:northstarbank.example:106400420", decision.evidence["strong_evidence"])
    ...
    def test_high_confidence_ai_lifecycle_rejects_conflicting_references(self) -> None:
        messages = [
            message("msg-1", thread_id="thread-1", signals={"sender_domain": "northstarbank.example", "ticket_id": "106400420"}),
            message("msg-2", thread_id="thread-2", signals={"sender_domain": "northstarbank.example", "ticket_id": "106756996"}),
        ]
        candidate = group(
            "group-ai",
    ...
    def test_conflict_resolver_gives_message_one_visible_home(self) -> None:
        messages = [message("msg-1", thread_id="thread-1"), message("msg-2", thread_id="thread-2")]
        strong = group("group-strong", group_key="ticket_id:northstarbank.example:106400420")
        weaker = replace(strong, id="group-weaker", group_key="ticket_id:northstarbank.example:106400420:duplicate", classification_confidence=0.81)
    ...
    def test_cross_entity_group_is_rejected_even_with_financial_language(self) -> None:
        messages = [
            ...
            message(
                ...
                signals={"sender_domain": "brokerage.example", "ticket_id": "106400420"},
            ),
        ]
