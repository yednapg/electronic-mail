...
class SpeedPipelineTests(unittest.TestCase):
    ...
    def test_candidate_groups_merge_cityflo_booking_lifecycle_threads_by_booking_id(self) -> None:
        booked = replace(
            ...
            sender="Cityflo <noreply@cityflo.com>",
            gmail_thread_id="thread-cityflo-booked",
            subject="Your Cityflo ride is booked",
            extracted_signals={"sender_domain": "cityflo.com", "booking_id": "CF123"},
        )
        modified = replace(
    ...
    def test_candidate_groups_normalize_exact_reference_sender_variants(self) -> None:
        ...
        self.assertEqual(list(candidates), ["ticket_id:hdfc-bank:106756996"])
        self.assertEqual([message.message_id for message in candidates["ticket_id:hdfc-bank:106756996"]], ["hdfc-grievance", "hdfc-service"])
    ...
    def test_visible_group_sender_falls_back_to_inbound_sender_when_projection_entity_is_user(self) -> None:
        ...
        self.assertEqual(rows[0].sender, "Penn State <admissions@psu.edu>")
    ...
    def test_attention_title_fallback_rejects_generic_application_update_subject(self) -> None:
        ...
        self.assertEqual(enrichment["ai_title"], "Penn State application rejection")
    ...
    def test_generic_ai_message_title_is_replaced_before_persistence(self) -> None:
        ...
        self.assertEqual(titles, {"psu-app": "Penn State application rejection"})
    ...
    def test_mailbox_keeps_related_cityflo_threads_separate_without_validated_projection(self) -> None:
        booking = replace(
            ...
            sender="Cityflo <support@cityflo.com>",
            snippet="Your bus booking is confirmed.",
            extracted_signals={"sender_domain": "cityflo.com", "normalized_subject": "your booking with cityflo"},
        )
        modified = replace(
            sample_message("cityflo-modified"),
            gmail_thread_id="thread-cityflo-modified",
            ...
            extracted_signals={"sender_domain": "cityflo.com", "normalized_subject": "your trip was modified successfully"},
        )
        cancelled = replace(
            sample_message("cityflo-cancelled"),
            gmail_thread_id="thread-cityflo-cancelled",
            ...
            extracted_signals={"sender_domain": "cityflo.com", "normalized_subject": "your trip was cancelled"},
        )
