...
class SpeedPipelineTests(unittest.TestCase):
    ...
    def test_candidate_groups_normalize_exact_reference_sender_variants(self) -> None:
        ...
        self.assertEqual(list(candidates), ["ticket_id:northstar-bank:106756996"])
        self.assertEqual([message.message_id for message in candidates["ticket_id:northstar-bank:106756996"]], ["northstar-grievance", "northstar-service"])
