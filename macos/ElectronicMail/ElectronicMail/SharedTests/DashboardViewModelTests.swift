...
final class DashboardViewModelTests: XCTestCase {
                ...
                GmailThreadSection(
                    ...
                    rows: [
                        GmailThreadRow(
                            ...
                            latestSender: "Apple <orders@fruitco.example>",
                            sender: "Apple",
                            participants: ["Apple"],
                            messageCount: 1,
    ...
    private func makeSmartAppSession(
        ...
        AppSessionResponse(
            user: AppSessionUser(id: "user-1", email: "user@example.com", firstName: "TestUser", displayName: "TestUser"),
            ...
            dashboard: DashboardResponse(
                ...
                profile: DashboardProfile(email: "user@example.com", displayName: "TestUser"),
                briefing: nil,
                feed: feed
            ),
