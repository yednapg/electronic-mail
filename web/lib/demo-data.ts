...
const rows: GmailThreadRow[] = [
  mailRow({
    ...
    updates: [
      ...
      ['demo-neo-3', '2026-05-01T18:16:00+05:30', 'Reference received from Shivay Lamba', 'Neo <noreply@neo.com>', 'Reference was received.'],
      ['demo-neo-2', '2026-05-01T12:23:25+05:30', 'Neo application received: Futuristic Intelligence', 'Neo <noreply@neo.com>', 'Application was received.'],
      ['demo-neo-1', '2026-04-30T16:02:00+05:30', 'Welcome to the Neo application platform, Gaurav!', 'Neo <noreply@neo.com>', 'Account setup started.'],
    ],
  }),
  mailRow({
    id: 'demo-calstate',
  ...
  mailRow({
    id: 'demo-hdfc',
    title: 'HDFC FX trading limit request',
    ...
    messageCount: 3,
    summary: 'HDFC replied on the trading limit request and needs review before the next FX Retail step.',
    actionNeeded: true,
    actionType: 'review',
    priority: 90,
    dashboardVisible: true,
  ...
  mailRow({
    id: 'demo-airtel',
    title: 'Airtel Black bill due soon',
    sender: 'Airtel <ebill@airtel.com>',
    subject: "Bill for your Airtel Black account - May'26",
    receivedAt: '2026-05-15T04:50:00+05:30',
    messageCount: 1,
    summary: 'Airtel generated the May bill. Review or pay it before the due date.',
    actionNeeded: true,
    actionType: 'pay',
    priority: 80,
    dashboardVisible: true,
  ...
  mailRow({
    ...
    sender: 'Gaurav & Sam <events@ycombinator.com>',
...
const dashboard: DashboardResponse = {
  ...
  briefing: {
    ...
    important: {
      emoji: '',
      count: 1,
      text: 'HDFC FX trading limit request',
      mail_group_id: 'demo-hdfc',
      action_type: 'review',
    },
  ...
  feed: {
    now: [
      attentionItem(rows[2], 'Review the HDFC FX trading limit reply before continuing the request.', 'review', 'high', 'now'),
      attentionItem(rows[0], 'Check the Neo Residency update and decide whether anything needs follow-up.', 'review', 'high', 'now'),
    ],
    today: [
      attentionItem(rows[3], 'Airtel generated the May bill and it should be handled before the due date.', 'pay', 'medium', 'today'),
    ],
    worth_knowing: [
